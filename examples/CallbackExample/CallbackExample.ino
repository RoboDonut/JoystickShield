...
void setup() {
    ...
    joystickShield.onSelectButton(&selectButton);
    joystickShield.onStartButton(&startButton);
}
...
void selectButton() {
    Serial.println("Select Button from callback");
}
void startButton() {
    Serial.println("Start Button from callback");
}
